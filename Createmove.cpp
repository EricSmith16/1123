...
bool __fastcall Hooks::CreateMove(void* thisptr, void*, float flInputSampleTime, CUserCmd* cmd)
{
	if (g_pEngine->IsConnected() && g_pEngine->IsInGame())
	{
		if (Clientvariables->Misc.clantag)
			switch (int(g_pGlobals->curtime * 2.4) % 27)
			{
			case 0: setclantag(XorStr("                  ")); break;
			case 1: setclantag(XorStr("                 b")); break;
			case 2: setclantag(XorStr("                bu")); break;
			case 3: setclantag(XorStr("               buf")); break;
			case 4: setclantag(XorStr("              buff")); break;
			case 5: setclantag(XorStr("             buff ")); break;
			case 6: setclantag(XorStr("            buff  ")); break;
			case 7: setclantag(XorStr("           buff   ")); break;
			case 8: setclantag(XorStr("          buff    ")); break;
			case 9: setclantag(XorStr("         buff     ")); break;
			case 10:setclantag(XorStr("        buff      ")); break;
			case 11:setclantag(XorStr("       buff       ")); break;
			case 12:setclantag(XorStr("      buff        ")); break;
			case 13:setclantag(XorStr("     buff         ")); break;
			case 14:setclantag(XorStr("    buff          ")); break;
			case 15:setclantag(XorStr("    buff          ")); break;
			case 16:setclantag(XorStr("    buff          ")); break;
			case 17:setclantag(XorStr("   buff           ")); break;
			case 18:setclantag(XorStr("  buff            ")); break;
			case 19:setclantag(XorStr(" buff             ")); break;
			case 20:setclantag(XorStr("buff              ")); break;
			case 22:setclantag(XorStr("uff               ")); break;
			case 23:setclantag(XorStr("ff                ")); break;
			case 24:setclantag(XorStr("f                 ")); break;
			case 25:setclantag(XorStr("                  ")); break;
			case 26:setclantag(XorStr("<3                ")); break;
			case 27:setclantag(XorStr("<3               ")); break;
