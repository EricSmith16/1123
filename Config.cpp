...
void Config::LoadConfig()
{
	...
	Clientvariables->Ragebot.BaimIfFakeWalk = ReadInt(("Ragebot"), ("baim if fakewalk"), 0);
    Clientvariables->Ragebot.BaimInAir = ReadInt(("Ragebot"), ("baim if in air"), 0);
   Clientvariables->Ragebot.BaimIfStanding = ReadInt(("Ragebot"), ("baim if standing"), 0);
	...
	WriteInt(("Visuals"), ("EventLogs"), Clientvariables->Visuals.EventLogs);
...
void Config::Reset()
{
	...
	Clientvariables->Ragebot.BaimIfFakeWalk = 0;
	Clientvariables->Ragebot.BaimInAir =  0;
	Clientvariables->Ragebot.BaimIfStanding = 0;
	...
	Clientvariables->Visuals.EventLogs = 0;
