...
public:
	...
	float GetInaccuracy()
	{
		...
		GetInaccuracyFn Inaccuracy = (GetInaccuracyFn)((*(PDWORD_PTR*)this)[ 470 ]); //459
	...
	float GetSpread()
	{
		...
		GetSpreadFn Spread = (GetSpreadFn)((*(PDWORD_PTR*)this)[ 439 ]);
		return Spread(this);
	}
	...
	void UpdateAccuracyPenalty()
	{
		...
		UpdateAccuracyPenaltyFn Update = (UpdateAccuracyPenaltyFn)((*(PDWORD_PTR*)this)[ 471 ]);
		return Update(this);
	}
	bool IsRifle()
	{
